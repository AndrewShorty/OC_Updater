...
loadfile("/bin/github.lua")("MightyPirates", "OpenComputers", "master-MC1.12", "src/main/resources/assets/opencomputers/loot/openos/", "41acf2fa06990dcc4d740490cccd9d2bcec97edd")
--]]
...
function Funktion.Pfad(api)
    if api then
        ...
        return "https://raw.githubusercontent.com/MightyPirates/OpenComputers/master-MC1.12/src/main/resources/assets/opencomputers/loot/openos/"
    end
end
...
function Funktion.checkKomponenten()
    ...
    local alleKomponenten = {
        {"internet", "- Eternet             ok", "- Eternet             missing", true},
        {"gpu",      "- GPU                  ok", "- GPU                  missing"},
    }
